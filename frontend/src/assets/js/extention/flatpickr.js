  ...
  function r(d, s) {
            ...
            if (
              ...
              ((h.daysContainer.style.width = e + 'px'),
                (h.calendarContainer.style.width =
                  e + (void 0 !== h.weekWrapper ? h.weekWrapper.offsetWidth : 0) + 'px'),
      ...
      if (0 !== h.selectedDates.length) {
        void 0 !== e &&
          ...
          (function (e) {
            ...
            void 0 !== h.amPM &&
              e.target === h.amPM &&
              (h.amPM.textContent = h.l10n.amPM[ee(h.amPM.textContent === h.l10n.amPM[0])]);
            ...
            if (void 0 !== n.value && 2 === n.value.length) {
              var d = n === h.hourElement,
                s = n === h.minuteElement;
              (c < a
                ? ((c = i + c + ee(!d) + (ee(d) && ee(!h.amPM))), s && v(void 0, -1, h.hourElement))
                : i < c &&
    ...
    function m() {
      if (void 0 !== h.hourElement && void 0 !== h.minuteElement) {
        ...
        void 0 !== h.amPM &&
          ((e = n), (t = h.amPM.textContent), (n = (e % 12) + 12 * ee(t === h.l10n.amPM[1])));
        var o =
      ...
      return n instanceof Array
        ...
        : t instanceof Array
          ...
          : (t.addEventListener(n, a, i),
            void h._handlers.push({ element: t, event: n, handler: a, options: i }));
    }
    function r(t) {
      return function (e) {
        1 === e.which && t(e);
    ...
    function D(e, t, n, a) {
      ...
      return (
        ...
        -1 === e.indexOf('hidden') &&
          0 === ce(t, h.now) &&
          ((h.todayDateElem = r).classList.add('today'), r.setAttribute('aria-current', 'date')),
        o
          ? ((r.tabIndex = -1),
            z(t) &&
              ...
              'range' === h.config.mode &&
                (fe(r, 'startRange', h.selectedDates[0] && 0 === ce(t, h.selectedDates[0], !0)),
    ...
    function w(e) {
      for (
        var t = 0 < e ? 0 : h.config.showMonths - 1, n = 0 < e ? h.config.showMonths : -1, a = t;
        a != n;
        a += e
      )
        for (
    ...
    function y(e, t) {
      ...
      for (var u = i + 1; u <= 42 - n && (1 === h.config.showMonths || s % 7 != 0); u++, s++)
    ...
    function x() {
      ...
      (i.setAttribute('aria-label', h.l10n.yearAriaLabel),
        ...
        h.config.maxDate &&
          (i.setAttribute('data-max', h.config.maxDate.getFullYear().toString()),
          (i.disabled =
            !!h.config.minDate &&
    ...
    function O(e) {
      return (
        !(!h.config.appendTo || !h.config.appendTo.contains(e)) || h.calendarContainer.contains(e)
      );
    }
    function S(t) {
      if (h.isOpen && !h.config.inline) {
        var e = O(t.target),
          n =
            ...
            (t.path && t.path.indexOf && (~t.path.indexOf(h.input) || ~t.path.indexOf(h.altInput))),
    ...
    function N(e, t) {
      ...
      if (
        ...
        (h.config.maxDate && n && 0 < ce(n, h.config.maxDate, void 0 !== t ? t : !h.maxDateHasTime))
      )
        return !1;
      if (0 === h.config.enable.length && 0 === h.config.disable.length) return !0;
      if (void 0 === n) return !1;
      for (
        var a, i = 0 < h.config.enable.length, o = i ? h.config.enable : h.config.disable, r = 0;
        r < o.length;
        r++
      ) {
          ...
          case 40:
            ...
            h.daysContainer && void 0 !== e.target.$i
              ? e.ctrlKey
                ...
                : o || C(void 0, 7 * l)
              : h.config.enableTime &&
                (!o && h.hourElement && h.hourElement.focus(), f(e), h._debouncedChange());
            break;
          case 9:
            if (!o) {
              h.element.focus();
    ...
    function P(o) {
      if (
        ...
        (!o || (o.classList.contains('flatpickr-day') && !o.classList.contains('disabled')))
      ) {
        for (
          var r = o ? o.dateObj.getTime() : h.days.firstElementChild.dateObj.getTime(),
                  ...
                  : c && !i
                    ...
                    : (['startRange', 'inRange', 'endRange', 'notAllowed'].forEach(function (e) {
                      ...
                      void (
                        void 0 !== o &&
                        (o.classList.add(
                          r < h.selectedDates[0].getTime() ? 'startRange' : 'endRange'
                        ),
                        (!f.contains(o) && 0 < u && m && m.lastChild.dateObj.getTime() >= a) ||
                          (l < r && a === l
    ...
    function L(e) {
      if (void 0 !== h.calendarContainer) {
        ...
        if (
          ...
          var u =
              window.pageXOffset + l.left - (null != r && 'center' === r ? (a - l.width) / 2 : 0),
    ...
    ((h.parseDate = le({ config: h.config, l10n: h.l10n })),
      ...
      (h.close = function () {
        ((h.isOpen = !1),
          h.isMobile ||
            (h.calendarContainer.classList.remove('open'), h._input.classList.remove('active')));
        q('onClose');
      }),
      (h._createElement = me),
      (h.destroy = function () {
      ...
      (h.open = function (e, t) {
        ...
        !0 === h.config.enableTime &&
          ...
          (0 === h.selectedDates.length &&
            (h.setDate(
              void 0 !== h.config.minDate ? new Date(h.config.minDate.getTime()) : new Date(),
              !1
            ),
            a(),
            Z()),
        ...
        ((h.element = h.input = d),
          ...
          (function () {
            ...
            (t.dateFormat ||
              ...
              (n.dateFormat =
                t.noCalendar || a
                  ...
                  : ve.defaultConfig.dateFormat + ' H:i' + (t.enableSeconds ? ':S' : '')),
              t.altInput &&
                (t.enableTime || a) &&
                !t.altFormat &&
                (n.altFormat =
                  t.noCalendar || a
                    ...
                    : ve.defaultConfig.altFormat + ' h:i' + (t.enableSeconds ? ':S' : '') + ' K'),
            ...
            (Object.defineProperty(h.config, 'minTime', {
              ...
              'time' === t.mode && ((h.config.noCalendar = !0), (h.config.enableTime = !0)),
          ...
          H(),
          (function () {
            if (((h.input = h.config.wrap ? d.querySelector('[data-input]') : d), !h.input))
                    ...
                    Object.defineProperty(h, '_hidePrevMonthArrow', {
                      ...
                      set: function (e) {
                        h.__hidePrevMonthArrow !== e &&
                          (fe(h.prevMonthNav, 'disabled', e), (h.__hidePrevMonthArrow = e));
                      },
                    }),
                    Object.defineProperty(h, '_hideNextMonthArrow', {
                      ...
                      set: function (e) {
                        h.__hideNextMonthArrow !== e &&
                          (fe(h.nextMonthNav, 'disabled', e), (h.__hideNextMonthArrow = e));
                      },
                    }),
          ...
          (function () {
            ...
            ((h._debouncedChange = te(g, he)),
              ...
              !0 === h.config.clickOpens &&
                (o(h._input, 'focus', h.open), o(h._input, 'mousedown', r(h.open))),
              void 0 !== h.daysContainer &&
