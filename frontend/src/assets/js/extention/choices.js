    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Choices = (function () {
          function Choices() {
            var element =
              arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-choice]';
                  ...
                  if (
                    ...
                    if (this.isSelectElement) {
                      ...
                      if (
                        ...
                        if (this.isSearching) {
                          notice = (0, _utils.isType)('Function', this.config.noResultsText)
                            ? this.config.noResultsText()
                            : this.config.noResultsText;

                          dropdownItem = this._getTemplate('notice', notice, 'no-results');
                        } else {
                          notice = (0, _utils.isType)('Function', this.config.noChoicesText)
	    ...
	    =============================================*/
            ...
            },
            {
              ...
              value: function _canAddItem(activeItems, value) {
                var canAddItem = true;
                var notice = (0, _utils.isType)('Function', this.config.addItemText)
                ...
                if (this.isSelectMultipleElement || this.isTextElement) {
                  if (
                    ...
                    // don't update
                    canAddItem = false;
                    notice = (0, _utils.isType)('Function', this.config.maxItemText)
                ...
                if (
                  ...
                  canAddItem = false;
                  notice = (0, _utils.isType)('Function', this.config.uniqueItemText)
                ...
                var onDirectionKey = function onDirectionKey() {
                  ...
                  if (hasActiveDropdown || _this16.isSelectOneElement) {
                    ...
                    if (skipKey) {
                      if (directionInt > 0) {
                        nextEl = Array.from(
                          _this16.dropdown.querySelectorAll('[data-choice-selectable]')
                        ).pop();
                      } else {
                    ...
                    if (nextEl) {
                      ...
                      if (
                        !(0, _utils.isScrolledIntoView)(nextEl, _this16.choiceList, directionInt)
                      ) {
              ...
              value: function _onMouseDown(e) {
                ...
                if (this.containerOuter.contains(target) && target !== this.input) {
                  ...
                  if ((foundTarget = (0, _utils.findAncestorByAttrName)(target, 'data-button'))) {
                    ...
                    (foundTarget = (0, _utils.findAncestorByAttrName)(target, 'data-item'))
                  ) {
                    this._handleItemAction(activeItems, foundTarget, hasShiftKey);
                  } else if (
                    (foundTarget = (0, _utils.findAncestorByAttrName)(target, 'data-choice'))
                  ) {
              ...
              value: function _highlightChoice() {
                ...
                if (choices && choices.length) {
                  var highlightedChoices = Array.from(
                    this.dropdown.querySelectorAll('.' + this.config.classNames.highlightedState)
                  );
            ...
            },
            {
              ...
              value: function _addGroup(group, id) {
                ...
                var valueKey =
                  arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'value';
                var labelKey =
                  arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'label';
                ...
                if (groupChoices) {
                  ...
                  groupChoices.forEach(function (option) {
                    var isOptDisabled =
                      option.disabled || (option.parentNode && option.parentNode.disabled);
                    _this21._addChoice(
                      option[valueKey],
                      (0, _utils.isType)('Object', option) ? option[labelKey] : option.innerHTML,
                      option.selected,
                      isOptDisabled,
                      groupId,
                  ...
                  this.store.dispatch(
                    (0, _index3.addGroup)(group.label, group.id, false, group.disabled)
                  );
                }
              },
                ...
                var templates = {
                  ...
                  item: function item(data) {
                    ...
                    var localClasses = (0, _classnames2.default)(
                      ...
                      _defineProperty(_classNames2, globalClasses.placeholder, data.placeholder),
                      _classNames2)
                    );
                    ...
                    if (_this22.config.removeItemButton) {
                      ...
                      localClasses = (0, _classnames2.default)(
                        ...
                        _defineProperty(_classNames3, globalClasses.itemSelectable, !data.disabled),
                        _defineProperty(_classNames3, globalClasses.placeholder, data.placeholder),
                        _classNames3)
                      );
                  ...
                  choiceGroup: function choiceGroup(data) {
                    var localClasses = (0, _classnames2.default)(
                      globalClasses.group,
                      _defineProperty({}, globalClasses.itemDisabled, data.disabled)
                    );
                  ...
                  choice: function choice(data) {
                    ...
                    var localClasses = (0, _classnames2.default)(
                      ...
                      ((_classNames5 = {}),
                      _defineProperty(_classNames5, globalClasses.itemDisabled, data.disabled),
                      _defineProperty(_classNames5, globalClasses.itemSelectable, !data.disabled),
                      _defineProperty(_classNames5, globalClasses.placeholder, data.placeholder),
                      _classNames5)
                    );
                  ...
                  notice: function notice(label) {
                    ...
                    var localClasses = (0, _classnames2.default)(
                      ...
                      globalClasses.itemChoice,
                      ((_classNames6 = {}),
                      _defineProperty(_classNames6, globalClasses.noResults, type === 'no-results'),
                      _defineProperty(_classNames6, globalClasses.noChoices, type === 'no-choices'),
                      _classNames6)
                    );
        ...
        (function (global) {
          ...
          function BitapSearcher(pattern, options) {
            ...
            this.options.distance =
              'distance' in options ? options.distance : BitapSearcher.defaultOptions.distance;
            this.options.threshold =
              'threshold' in options ? options.threshold : BitapSearcher.defaultOptions.threshold;
            this.options.maxPatternLength =
              options.maxPatternLength || BitapSearcher.defaultOptions.maxPatternLength;
	...
	*/
      ...
      /***/ function (module, exports) {
        ...
        var general = function general() {
          var state =
            arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { loading: false };
          var action = arguments[1];
